  ...
  return(
    ...
    {/* caption */}
    <span className="text-[white] mx-auto mt-[5vh] md:mt-[5vh] text-2xl font-bold md:text-4xl z-3 fade-up" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>Hello, I am Christian Trio</span>
    
    {/* location */}
    <div className="flex mx-auto mt-[6vh] md:mt-[5vh] items-center gap-1 fade-up">
    ...
    {/* profession */}
    <div className='mx-auto flex justify-center items-center mt-[8vh] md:mt-[6vh] fade-up'>
